...
function main(config) {
    ...
    if (isTwo) {
        config['proxy-groups'] = group.map((name) => {
            const startName = []
            const endName = []
            if (['🌍国外媒体', '✈️电报信息', '📢谷歌fCM', '🐟漏网之鱼'].includes(name)) {
                startName.push('🚀节点选择', '🧱直接连接')
            }
            else if (['🎬国内媒体', 'Ⓜ️微软服务', '🍎苹果服务'].includes(name)) {
                startName.push('🧱直接连接', '🚀节点选择')
            }
            else if (['🛑全球拦截', '🍃应用净化'].includes(name)) {
                startName.push('REJECT', 'DIRECT')
            }
            else if (name === '🚀节点选择') {
                endName.push('🧱直接连接')
            }
...
function getRules() {
    return [
        'DOMAIN-SUFFIX,smtp,🧱直接连接',
        'DOMAIN-KEYWORD,aria2,🧱直接连接',
        'DOMAIN-SUFFIX,acl4.ssr,🧱直接连接',
        ...
        'IP-CIDR,198.18.0.0/16,🧱直接连接,no-resolve',
        ...
        'DOMAIN,instant.arubanetworks.com,🧱直接连接',
        'DOMAIN,setmeup.arubanetworks.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,router.ctc,🧱直接连接',
        'DOMAIN-SUFFIX,routerlogin.com,🧱直接连接',
        'DOMAIN-SUFFIX,tendawifi.com,🧱直接连接',
        'DOMAIN-SUFFIX,zte.home,🧱直接连接',
        'DOMAIN-SUFFIX,ol.epicgames.com,🧱直接连接',
        'DOMAIN-SUFFIX,dizhensubao.getui.com,🧱直接连接',
        'DOMAIN-SUFFIX,tracking-protection.cdn.mozilla.net,🧱直接连接',
        'DOMAIN,origin-a.akamaihd.net,🧱直接连接',
        'DOMAIN,xivanalysis.com,🧱直接连接',
        'DOMAIN,picanalysis.vivo.com.cn,🧱直接连接',
        'DOMAIN,fairplay.l.qq.com,🧱直接连接',
        'DOMAIN,livew.l.qq.com,🧱直接连接',
        'DOMAIN,vd.l.qq.com,🧱直接连接',
        'DOMAIN,analytics.strava.com,🧱直接连接',
        'DOMAIN,errlog.umeng.com,🧱直接连接',
        'DOMAIN,msg.umeng.com,🧱直接连接',
        'DOMAIN,msg.umengcloud.com,🧱直接连接',
        'DOMAIN,tracking.miui.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,265.com,🧱直接连接',
        'DOMAIN-SUFFIX,2mdn.net,🧱直接连接',
        'DOMAIN-SUFFIX,app-measurement.com,🧱直接连接',
        'DOMAIN-SUFFIX,clickserve.dartsearch.net,🧱直接连接',
        'DOMAIN-SUFFIX,crl.pki.goog,🧱直接连接',
        'DOMAIN-SUFFIX,gtm.oasisfeng.com,🧱直接连接',
        'DOMAIN-SUFFIX,ocsp.pki.goog,🧱直接连接',
        'DOMAIN-SUFFIX,recaptcha.net,🧱直接连接',
        'DOMAIN-SUFFIX,settings.crashlytics.com,🧱直接连接',
        'DOMAIN,csgo.wmsj.cn,🧱直接连接',
        'DOMAIN,dl.steam.clngaa.com,🧱直接连接',
        'DOMAIN,dl.steam.ksyna.com,🧱直接连接',
        'DOMAIN,dota2.wmsj.cn,🧱直接连接',
        'DOMAIN,st.dl.bscstorage.net,🧱直接连接',
        'DOMAIN,st.dl.eccdnx.com,🧱直接连接',
        'DOMAIN,st.dl.pinyuncloud.com,🧱直接连接',
        'DOMAIN,steampipe.steamcontent.tnkjmec.com,🧱直接连接',
        'DOMAIN,steampowered.com.8686c.com,🧱直接连接',
        'DOMAIN,steamstatic.com.8686c.com,🧱直接连接',
        'DOMAIN,wmsjsteam.com,🧱直接连接',
        'DOMAIN-SUFFIX,cm.steampowered.com,🧱直接连接',
        'DOMAIN-SUFFIX,steamchina.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,a767.dscg3.akamai.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,aadrm.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,acompli.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,acompli.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,adaptivecards.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,aicscience.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,aka.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,akadns.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ankarazirvesi2018.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,api-extractor.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,apisof.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,applicationinsights.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,applicationinsights.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,aria.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,asp.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,aspnetcdn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,assets-yammer.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-apim.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-dns.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-dns.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-dns.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-dns.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-mobile.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-sphere.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure-test.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azure.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecomcdn.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecontainer.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecosmos.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecosmosdb.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecosmosdb.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurecosmosdb.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredatabricks.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredevopslaunch.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredigitaltwin.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredigitaltwins.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredigitaltwins.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredns-prd.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuredns-prd.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureedge-test.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurefd.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurefd.us,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureiotcentral.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureiotsolutions.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureiotsuite.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureplanetscale.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureplanetscale.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurerms.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azureserviceprofiler.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azuresmartspaces.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurestackvalidation.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,azurewebsites.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,b.akamaiedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bbing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,beth.games,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bethesda.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bethesdagamestudios.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bethsoft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bibg.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,biing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,binads.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,binb.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,binf.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing123.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing135.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bing4.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingads.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingagencyawards.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingapis.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingapistatistics.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,binginternal.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingit.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingiton.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingj.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingpix.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingpk.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bings.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingsandbox.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingtoolbar.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingtranslator.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingvisualsearch.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bingworld.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,biying.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,biying.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,biying.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,blazor.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bluehatil.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,bluehatnights.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,boswp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,botframework.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,brazilpartneruniversity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,breakdown.me,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,c-msedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,callersbane.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,centralvalidation.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ch9.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,charticulator.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,chinacloudapi.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,chinacloudapp.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,chinacloudsites.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cloudapp.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cloudappsecurity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,codethemicrobit.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cortana.ai,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cortanaanalytics.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cortanaskills.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cosmosdb.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cosmosdb.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,crmdynint-gcc.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,crmdynint.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,crossborderexpansion.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cs11.wpc.v0cdn.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,cs9.wac.phicdn.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,devopsassessment.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,devopsms.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,dictate.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,discoverbing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,docs.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,dot.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,dwh5.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,dynamics.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,e-msedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,edgesuite.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,efproject.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,engkoo.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,evoke-windowsservices-tas.msedge,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,exp-tas.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,explorebing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,fabric.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,fasttrackreadysupport.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,femalefounderscomp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,flipwithsurface.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,fluidpreview.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,footprintdns.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,forzamotorsport.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,forzaracingchampionship.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,forzarc.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,g.akamaiedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gamepass.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gamesstack.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gameuxmasterguide.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gears5.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gearspop.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gearstactics.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,getmicrosoftkey.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gfx.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gigjam.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,gotcosmos.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,graphengine.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,groupme.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,helpshift.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,here.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,here.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,heremaps.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hockeyapp.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hololens.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hotmail.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,hummingbird.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ie10.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ie11.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ie8.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ie9.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,imaginecup.pl,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,img-prod-cms-rt-microsoft-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,img-s-msn-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ingads.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,insiderdevtour.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,internetexplorer.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,internetexplorer.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,intunewiki.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,iotinactionevents.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,joinms.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,joinms.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,joinmva.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,jwt.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,kidgrid.tv,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,kumo.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,latampartneruniversity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,live.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,live.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,live.com.au,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,live.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,live.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,livetileedge.dsx.mp.microsoft.com.edgekey.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,livingyourambition.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,localytics.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,lync.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,m12.vc,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,makecode.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,managedmeetingrooms.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mapblast.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mappoint.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,masalladeloslimites.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,meetfasttrack.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,meetyourdevices.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mepn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mesh.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microbit.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-give.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-int.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-online.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-online.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-ppe.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-sap-events.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-sbs-domains.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-smb.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft-tst.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.az,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.be,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.by,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ca,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.cat,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ch,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.cl,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.com.nsatc.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.cz,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.de,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.dk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ee,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.es,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.fi,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ge,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.hu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.is,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.it,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.jp,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.lt,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.lu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.lv,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.md,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.pl,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.pt,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.red,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ro,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.rs,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ru,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.se,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.si,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.tv,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.ua,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.uz,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft.vn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoft365.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftaccountguard.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftadc.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftads.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftadvertising.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftadvertisingregionalawards.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftaffiliates.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftazuread-sso.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftcloud.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftcloudsummit.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftcloudworkshop.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftcommunitytraining.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftdiplomados.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsofteca.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftedge.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftedgeinsider.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftemail.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftestore.com.hk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftgamestack.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsofthouse.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsofthouse.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftinternetsafety.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftiotcentral.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftiotinsiderlabs.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftlatamaitour.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftlatamholiday.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftlinc.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftmxfilantropia.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnews.cc,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnews.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnews.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnews.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnews.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewsforkids.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewsforkids.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewsforkids.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewskids.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewskids.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftnewskids.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftol.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftol.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftonline-p.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftonline-p.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftonline.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftpartnercommunity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftpartnersolutions.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftreactor.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftreactor.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftreactor.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftreactor.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftreactor.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftready.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftsilverlight.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftsilverlight.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftsilverlight.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftsiteselection.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftsqlserver.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftstore.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftstore.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftstore.com.hk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftstream.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftteams.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsofttradein.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsofttranslator.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftusercontent.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,microsoftuwp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,minecraft.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,minecraftshop.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mmais.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mmdnn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mojang.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,momentumms.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mono-project.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,morphcharts.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mpnevolution.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ms-studiosmedia.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ms365surfaceoffer.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msa.akadns6.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msads.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msappproxy.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msauth.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msauth.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msauthimages.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mschallenge2018.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msdn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msecnd.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msft.info,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msft.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftauth.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftauth.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftauthimages.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftcenterone.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftconnecttest.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msfteducation.ca,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftidentity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msftnet.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msgamesresearch.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msgamestudios.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msidentity.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msignitechina.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msinnovationchallenge.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msminico.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msminico.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msn.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msn.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msn.com.nsatc.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msn.com.tw,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msnewskids.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msnewskids.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msnewskids.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msnkids.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msnmaps.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msocdn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msocsp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msopentech.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mspairlift.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mspil.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msra.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msropendata.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mstea.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msturing.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msudalosti.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msunlimitedcloudsummit.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msvevent.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msxiaobing.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msxiaoice.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,msxiaona.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mwf-service.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,myhomemsn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,mymicrosoft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,nextechafrica.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,nuget.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,nugettest.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,nxta.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,o365cn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,o365files.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,o365weve-dev.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,o365weve-ppe.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,o365weve.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,oaspapps.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office365.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office365love.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,office365tw.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,officecdn-microsoft-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,officedev.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,officeplus.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,officeppe.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,omniroot.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onecollector.cloudapp.aria,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onedrive.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onedrive.co.uk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onedrive.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onedrive.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onedrive.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onenote.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onenote.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onestore.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,onmicrosoft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,opentranslatorstothings.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,opticsforthecloud.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,optimizely.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,orithegame.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,osdinfra.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,outingsapp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,outlook.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,outlook.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,outlookgroups.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,outlookmobile.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,ovi.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,passport.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,phonefactor.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,pixapp.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,playfabapi.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,playfabcn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,poshtestgallery.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,powerappscdn.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,powerautomate.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,powerbi.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,powershellgallery.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,prod-video-cms-rt-microsoft-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,projectmurphy.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,projectsangam.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,public-trust.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,pwabuilder.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,pxt.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,reactorms.com.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,renlifang.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,renovacionoffice.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,renovacionxboxlive.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,s-microsoft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,s-msedge.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,s-msft.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,s-msn.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sankie.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sclive.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,serverlesslibrary.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sfbassets.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sfbassets.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sfx.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sharepoint.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,signalr.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skype,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skype.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skype.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skypeassets.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skypeassets.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,skypeforbusiness.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sprinklesapp.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sqlserveronlinux.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,staffhub.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,statics-marketingsites-eas-ms-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,statics-marketingsites-eus-ms-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,statics-marketingsites-neu-ms-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,statics-marketingsites-wcus-ms-com.akamaized.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,successwithteams.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,surface.com,Ⓜ️微软服务',
        ...
        'DOMAIN-SUFFIX,syncshop.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,sysinternals.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,tailwindtraders.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,techhub.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,tellmewhygame.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,tfsallin.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,timelinestoryteller.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,trafficmanager.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,translatetheweb.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,tryfunctions.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,unlocklimitlesslearning.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,userpxt.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,uservoice.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,uwpcommunitytoolkit.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vfsforgit.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vfsforgit.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,videobreakdown.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,videoindexer.ai,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vip5.afdorigin-prod-am02.afdogw.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,virtualearth.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio-staging.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio.co.uk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,visualstudio.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vsallin.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vsassets.io,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vscode-unpkg.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vscode-webview.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,vscode.dev,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,wbd.ms,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,what-fan.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows-int.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows-ppe.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows.nl,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windows8.hk,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsazure.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsazure.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowscommunity.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowslive.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsmarketplace.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsphone-int.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsphone.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowssearch.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,windowsupdate.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,winhec.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,winhec.net,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,winmp.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,wlxrs.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,working-bing-int.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,wunderlist.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xamarin.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox360.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox360.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox360.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbox360.org,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxab.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxgamepass.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxgamestudios.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxlive.cn,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxlive.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxone.co,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxone.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxone.eu,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxplayanywhere.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxservices.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xboxstudios.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,xbx.lv,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,yammer.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,yammerusercontent.com,Ⓜ️微软服务',
        'DOMAIN-SUFFIX,1drv.com,Ⓜ️微软服务',
        ...
        'DOMAIN-SUFFIX,t.me,✈️电报信息',
        'DOMAIN-SUFFIX,tdesktop.com,✈️电报信息',
        'DOMAIN-SUFFIX,telegra.ph,✈️电报信息',
        'DOMAIN-SUFFIX,telegram.me,✈️电报信息',
        'DOMAIN-SUFFIX,telegram.org,✈️电报信息',
        'DOMAIN-SUFFIX,telesco.pe,✈️电报信息',
        'IP-CIDR,91.108.0.0/16,✈️电报信息,no-resolve',
        'IP-CIDR,109.239.140.0/24,✈️电报信息,no-resolve',
        'IP-CIDR,149.154.160.0/20,✈️电报信息,no-resolve',
        'IP-CIDR6,2001:67c:4e8::/48,✈️电报信息,no-resolve',
        'IP-CIDR6,2001:b28:f23d::/48,✈️电报信息,no-resolve',
        'IP-CIDR6,2001:b28:f23f::/48,✈️电报信息,no-resolve',
        ...
        'DOMAIN-SUFFIX,podcasts.apple.com,🌍国外媒体',
        ...
        'DOMAIN-SUFFIX,intl-rcd.iqiyi.com,🎬国内媒体',
        'DOMAIN-SUFFIX,intl-subscription.iqiyi.com,🎬国内媒体',
        ...
        'DOMAIN-SUFFIX,clientservices.googleapis.com,🚀节点选择',
        ...
        'DOMAIN-SUFFIX,imasdk.googleapis.com,🚀节点选择',
        'DOMAIN-SUFFIX,mtalk.google.com,🚀节点选择',
        'DOMAIN-SUFFIX,safebrowsing-cache.google.com,🚀节点选择',
        'DOMAIN-SUFFIX,safebrowsing.googleapis.com,🚀节点选择',
        ...
        'DOMAIN-SUFFIX,pressx.ink,🚀节点选择',
        'DOMAIN-SUFFIX,mox.moe,🚀节点选择',
        'DOMAIN-SUFFIX,blizzard.com,🚀节点选择',
        'DOMAIN-SUFFIX,battlenet.net,🚀节点选择',
        'DOMAIN-SUFFIX,openai.com,🚀节点选择',
        'DOMAIN-SUFFIX,chat.openai.com,🚀节点选择',
        ...
        'DOMAIN-SUFFIX,chatgpt.com,🚀节点选择',
        'DOMAIN-SUFFIX,13th.tech,🧱直接连接',
        'DOMAIN-SUFFIX,423down.com,🧱直接连接',
        'DOMAIN-SUFFIX,bokecc.com,🧱直接连接',
        'DOMAIN-SUFFIX,chaipip.com,🧱直接连接',
        'DOMAIN-SUFFIX,chinaplay.store,🧱直接连接',
        'DOMAIN-SUFFIX,hrtsea.com,🧱直接连接',
        'DOMAIN-SUFFIX,kaikeba.com,🧱直接连接',
        'DOMAIN-SUFFIX,laomo.me,🧱直接连接',
        'DOMAIN-SUFFIX,mpyit.com,🧱直接连接',
        'DOMAIN-SUFFIX,msftconnecttest.com,🧱直接连接',
        'DOMAIN-SUFFIX,msftncsi.com,🧱直接连接',
        'DOMAIN-SUFFIX,qupu123.com,🧱直接连接',
        'DOMAIN-SUFFIX,pdfwifi.com,🧱直接连接',
        'DOMAIN-SUFFIX,zhenguanyu.biz,🧱直接连接',
        'DOMAIN-SUFFIX,zhenguanyu.com,🧱直接连接',
        'DOMAIN-SUFFIX,cn,🧱直接连接',
        'DOMAIN-SUFFIX,xn--fiqs8s,🧱直接连接',
        'DOMAIN-SUFFIX,xn--55qx5d,🧱直接连接',
        'DOMAIN-SUFFIX,xn--io0a7i,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,alicloudccp.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,aliyundrive.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,bigfun.cn,🧱直接连接',
        'DOMAIN-SUFFIX,bigfunapp.cn,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,bilivideo.cn,🧱直接连接',
        'DOMAIN-SUFFIX,hdslb.com,🧱直接连接',
        'DOMAIN-SUFFIX,im9.com,🧱直接连接',
        'DOMAIN-SUFFIX,smtcdns.net,🧱直接连接',
        'DOMAIN-SUFFIX,amemv.com,🧱直接连接',
        'DOMAIN-SUFFIX,bdxiguaimg.com,🧱直接连接',
        'DOMAIN-SUFFIX,bdxiguastatic.com,🧱直接连接',
        'DOMAIN-SUFFIX,byted-static.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytedance.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytedance.net,🧱直接连接',
        'DOMAIN-SUFFIX,bytedns.net,🧱直接连接',
        'DOMAIN-SUFFIX,bytednsdoc.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytegoofy.com,🧱直接连接',
        'DOMAIN-SUFFIX,byteimg.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytescm.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytetos.com,🧱直接连接',
        'DOMAIN-SUFFIX,bytexservice.com,🧱直接连接',
        'DOMAIN-SUFFIX,douyin.com,🧱直接连接',
        'DOMAIN-SUFFIX,douyinpic.com,🧱直接连接',
        'DOMAIN-SUFFIX,douyinstatic.com,🧱直接连接',
        'DOMAIN-SUFFIX,douyinvod.com,🧱直接连接',
        'DOMAIN-SUFFIX,feelgood.cn,🧱直接连接',
        'DOMAIN-SUFFIX,feiliao.com,🧱直接连接',
        'DOMAIN-SUFFIX,gifshow.com,🧱直接连接',
        'DOMAIN-SUFFIX,huoshan.com,🧱直接连接',
        'DOMAIN-SUFFIX,huoshanzhibo.com,🧱直接连接',
        'DOMAIN-SUFFIX,ibytedapm.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,toutiao13.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaoapi.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaocdn.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaocdn.net,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaocloud.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaohao.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaohao.net,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaoimg.com,🧱直接连接',
        'DOMAIN-SUFFIX,toutiaopage.com,🧱直接连接',
        'DOMAIN-SUFFIX,wukong.com,🧱直接连接',
        'DOMAIN-SUFFIX,zijieapi.com,🧱直接连接',
        'DOMAIN-SUFFIX,zijieimg.com,🧱直接连接',
        'DOMAIN-SUFFIX,zjbyte.com,🧱直接连接',
        'DOMAIN-SUFFIX,zjcdn.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,douyuscdn.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,kuaishou.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,steamusercontent.com,🧱直接连接',
        'DOMAIN-SUFFIX,steamchina.com,🧱直接连接',
        'DOMAIN,steampipe.akamaized.net,🧱直接连接',
        'DOMAIN,csgo.wmsj.cn,🧱直接连接',
        'DOMAIN,dota2.wmsj.cn,🧱直接连接',
        'DOMAIN,wmsjsteam.com,🧱直接连接',
        'DOMAIN,dl.steam.clngaa.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,00cdn.com,🧱直接连接',
        'DOMAIN-SUFFIX,88cdn.com,🧱直接连接',
        'DOMAIN-SUFFIX,kanimg.com,🧱直接连接',
        'DOMAIN-SUFFIX,kankan.com,🧱直接连接',
        'DOMAIN-SUFFIX,p2cdn.com,🧱直接连接',
        'DOMAIN-SUFFIX,sandai.net,🧱直接连接',
        'DOMAIN-SUFFIX,thundercdn.com,🧱直接连接',
        'DOMAIN-SUFFIX,xunlei.com,🧱直接连接',
        'DOMAIN-SUFFIX,got001.com,🧱直接连接',
        'DOMAIN-SUFFIX,p4pfile.com,🧱直接连接',
        'DOMAIN-SUFFIX,rrys.tv,🧱直接连接',
        'DOMAIN-SUFFIX,rrys2020.com,🧱直接连接',
        'DOMAIN-SUFFIX,yyets.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,lanzoui.com,🧱直接连接',
        'DOMAIN-SUFFIX,lanzoux.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,migucloud.com,🧱直接连接',
        ...
        'DOMAIN-SUFFIX,synology.com,🧱直接连接',
        ...
        'IP-CIDR,8.128.0.0/10,🧱直接连接,no-resolve',
        'IP-CIDR,8.208.0.0/12,🧱直接连接,no-resolve',
        'IP-CIDR,14.1.112.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,41.222.240.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,41.223.119.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,43.242.168.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,45.112.212.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,47.52.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,47.56.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,47.74.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,47.76.0.0/14,🧱直接连接,no-resolve',
        'IP-CIDR,47.80.0.0/12,🧱直接连接,no-resolve',
        'IP-CIDR,47.235.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,47.236.0.0/14,🧱直接连接,no-resolve',
        'IP-CIDR,47.240.0.0/14,🧱直接连接,no-resolve',
        'IP-CIDR,47.244.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,47.246.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,47.250.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,47.252.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,47.254.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,59.82.0.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,59.82.240.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,59.82.248.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,72.254.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,103.38.56.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.52.76.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.206.40.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,110.76.21.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,110.76.23.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,112.125.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,116.251.64.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,119.38.208.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,119.38.224.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,119.42.224.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,139.95.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,140.205.1.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,140.205.122.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,147.139.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,149.129.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,155.102.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,161.117.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,163.181.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,170.33.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,198.11.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,205.204.96.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,19.28.0.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,45.40.192.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,49.51.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,62.234.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,94.191.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,103.7.28.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.116.50.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.231.60.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,109.244.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,111.30.128.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,111.30.136.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,111.30.139.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,111.30.140.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,115.159.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,119.28.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,120.88.56.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,121.51.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,129.28.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,129.204.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,129.211.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,132.232.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,134.175.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,146.56.192.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,148.70.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,150.109.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,152.136.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,162.14.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,162.62.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,170.106.130.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,182.254.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,188.131.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,203.195.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,203.205.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,210.4.138.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,211.152.128.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,211.152.132.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,211.152.148.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,212.64.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,212.129.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,45.113.192.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,63.217.23.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,63.243.252.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,103.235.44.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,104.193.88.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,106.12.0.0/15,🧱直接连接,no-resolve',
        'IP-CIDR,114.28.224.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,119.63.192.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,180.76.0.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,180.76.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,182.61.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,185.10.104.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,202.46.48.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,203.90.238.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,43.254.0.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,45.249.212.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,49.4.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,78.101.192.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,78.101.224.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,81.52.161.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,85.97.220.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.31.200.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.69.140.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.218.216.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,114.115.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,114.116.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,116.63.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,116.66.184.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.96.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.128.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.136.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.141.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.142.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.243.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.244.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,116.71.251.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,117.78.0.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,119.3.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,119.8.0.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,119.8.32.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,121.36.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,121.36.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,121.37.0.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,122.112.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.0.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.64.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.100.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.104.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.112.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.192.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.224.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.240.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,139.9.248.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.128.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.160.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.164.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.168.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.176.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,139.159.192.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.0.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.64.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.79.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.80.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.96.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.112.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.125.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.192.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.223.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,159.138.224.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,168.195.92.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,185.176.76.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,197.199.0.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,197.210.163.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,197.252.1.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,197.252.2.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,197.252.4.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,197.252.8.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,200.32.52.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,200.32.54.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,200.32.57.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.0.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.4.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.8.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.11.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.13.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.20.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.22.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.24.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.26.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.29.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.33.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.38.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.40.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.43.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.48.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,203.135.50.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,42.186.0.0/16,🧱直接连接,no-resolve',
        'IP-CIDR,45.127.128.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,45.195.24.0/24,🧱直接连接,no-resolve',
        'IP-CIDR,45.253.132.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,45.253.240.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,45.254.48.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,59.111.0.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,59.111.128.0/17,🧱直接连接,no-resolve',
        'IP-CIDR,103.71.120.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,103.71.128.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.71.196.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.71.200.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.12.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.18.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.24.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.28.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.38.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.40.0/23,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.44.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.48.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,103.72.128.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,103.74.24.0/21,🧱直接连接,no-resolve',
        'IP-CIDR,103.74.48.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.126.92.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.129.252.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.131.252.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.135.240.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,103.196.64.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,106.2.32.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,106.2.64.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,114.113.196.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,114.113.200.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,115.236.112.0/20,🧱直接连接,no-resolve',
        'IP-CIDR,115.238.76.0/22,🧱直接连接,no-resolve',
        'IP-CIDR,123.58.160.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,223.252.192.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,101.198.128.0/18,🧱直接连接,no-resolve',
        'IP-CIDR,101.198.192.0/19,🧱直接连接,no-resolve',
        'IP-CIDR,101.199.196.0/22,🧱直接连接,no-resolve',
    ]
}
